...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rswag-specs>.freeze, ["= 2.12.0"])
  s.add_runtime_dependency(%q<rswag-api>.freeze, ["= 2.12.0"])
  s.add_runtime_dependency(%q<rswag-ui>.freeze, ["= 2.12.0"])
end
